...
export interface V3PoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "collect"
...
export interface V3Pool extends BaseContract {
  connect(runner?: ContractRunner | null): V3Pool;
  waitForDeployment(): Promise<this>;

  interface: V3PoolInterface;
